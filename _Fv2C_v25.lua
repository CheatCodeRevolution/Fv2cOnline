...
local offsets = {
    ["28.5.178"] = {
        Remove=0x3203c4c, --SVInventory::Remove
CanExpandWithCoins=0x32f8f70, --LandExpansionManager::CanExpandWithCoins
GetItemCost=0x32db900, --ItemManager::GetItemCost
GetFastFinishCost=0x356864c, --SVFastFinish::GetFastFinishCost
CalculateBuyThroughCost=0x28ecdbc, --MerchantOfferCell::CalculateBuyThroughCost
GetCraftingTimeMultiplierForBuildingLevel=0x2a4412c, --UpgradeableBuilding::GetCraftingTimeMultiplierForBuildingLevel
GetCountyFairPointsMultiplierForBuildingLevel=0x2a4419c, --UpgradeableBuilding::GetCountyFairPointsMultiplierForBuildingLevel
get_KnightRequestIntervalSeconds=0x2e6c2b4, --AllianceKnightsManager::get_KnightRequestIntervalSeconds
get_HandsToSend=0x2e6e29c, --AllianceManager::get_HandsToSend
CreateOffer=0x3789df0, --SeafarerManager::CreateOffer
GetAutoBuyTime=0x377cc7c, --SeafarerManager::GetAutoBuyTime
GetNumCoopOnlySlotsInUse=0x3780970, --SeafarerManager::GetNumCoopOnlySlotsInUse
get_getAmountHas=0x26bf264, --CoopOrderCard_ViewModel::get_getAmountHas
get_getAmountRequired=0x26bf404, --CoopOrderCard_ViewModel::get_getAmountRequired
get_isCoopOrderExpired=0x26bf7f8, --CoopOrderCard_ViewModel::get_isCoopOrderExpired
canShowThanksGivingStickers=0x315b510, --GameExpression::canShowThanksGivingStickers
canShowChristmasStickers=0x315b64c, --GameExpression::canShowChristmasStickers
CanPlayForFree=0x26513ec, --GameOfChanceGame::CanPlayForFree
get_totalItemsCount=0x3613f58, --ProtoStorageLevel::get_totalItemsCount
get_IsCheaterFixOn=0x381dcc0, --BoatRaceV4Context::get_IsCheaterFixOn
get_CheaterTrackingEnabled=0x3811b1c, --BoatRaceV4Context::get_CheaterTrackingEnabled
set_CheaterTrackingEnabled=0x3811b24, --BoatRaceV4Context::set_CheaterTrackingEnabled
CheaterFixedScore=0x381e2ac, --BoatRaceV4Context::CheaterFixedScore
get_Suspended=0x2d8b0d8, --ZyngaUsersession::get_Suspended
set_Suspended=0x2d8b0e0, --ZyngaUsersession::set_Suspended
Start=0x2ac0ae0, --ZyngaPlayerSuspensionManager::Start
get_amount=0x331c904, --ProtoQuestReward::get_amount
get_GetCurrentLeaguePersonalQuota=0x37e5ed0, --BoatRaceLeagueManager::get_GetCurrentLeaguePersonalQuota
get_personalQuotaCompleted=0x2c52018, --BaseBoatRaceContext::get_personalQuotaCompleted
get_bonusTaskCount=0x2c51fd8, --BaseBoatRaceContext::get_bonusTaskCount
get_GetBonusTaskSkipPrice=0x26a8d60, --BoatRace_TaskTabViewModel::get_GetBonusTaskSkipPrice
getAmount=0x331d8b8, --ProtoQuestTask::getAmount
set_MyWeeklyContribution=0x38473c4, --CoopOrderHelpContext::set_MyWeeklyContribution
StartCrafting=0x2aa8c30, --WorkshopManager::StartCrafting
get_inventoryTokens=0x2f10ed0, --BattlePassManager::get_inventoryTokens
isEntityObstructed=0x2fe031c, --EntityPlacementController::isEntityObstructed
get_IsAvailable=0x3298868, --HeroBehavior::get_IsAvailable
OnTamperDetected=0x332561c, --SecureVarInt::OnTamperDetected
CurrentUnix=0x354e3fc, --PartnerAnimalTime::CurrentUnix
get_SpinLeft=0x37a4894, --SocialDailyBonusManager::get_SpinLeft
get_groupLimit=0x3208bc8, --ProtoMarketItem::get_groupLimit
GetAmount=0x3312560, --ProtoLootInfoExtensions::GetAmount
GetDropRate=0x33146e8, --ProtoLootInfoExtensions::GetDropRate
    },
