...
local offsets = {
  ["28.6.95"] = {
    Remove = 0x3212574, --SVInventory::Remove
    CanExpandWithCoins = 0x3308d14, --LandExpansionManager::CanExpandWithCoins
    GetItemCost = 0x32eb570, --ItemManager::GetItemCost
    GetFastFinishCost = 0x35797dc, --SVFastFinish::GetFastFinishCost
    CalculateBuyThroughCost = 0x28f5088, --MerchantOfferCell::CalculateBuyThroughCost
    GetCraftingTimeMultiplierForBuildingLevel = 0x2a50a5c, --UpgradeableBuilding::GetCraftingTimeMultiplierForBuildingLevel
    GetCountyFairPointsMultiplierForBuildingLevel = 0x2a50acc, --UpgradeableBuilding::GetCountyFairPointsMultiplierForBuildingLevel
    get_KnightRequestIntervalSeconds = 0x2e78948, --AllianceKnightsManager::get_KnightRequestIntervalSeconds
    get_HandsToSend = 0x2e7a930, --AllianceManager::get_HandsToSend
    CreateOffer = 0x37a04e0, --SeafarerManager::CreateOffer
    GetAutoBuyTime = 0x379343c, --SeafarerManager::GetAutoBuyTime
    GetNumCoopOnlySlotsInUse = 0x3797090, --SeafarerManager::GetNumCoopOnlySlotsInUse
    get_getAmountHas = 0x26c5bc8, --CoopOrderCard_ViewModel::get_getAmountHas
    get_getAmountRequired = 0x26c5d68, --CoopOrderCard_ViewModel::get_getAmountRequired
    get_isCoopOrderExpired = 0x26c615c, --CoopOrderCard_ViewModel::get_isCoopOrderExpired
    canShowThanksGivingStickers = 0x3169490, --GameExpression::canShowThanksGivingStickers
    canShowChristmasStickers = 0x31695cc, --GameExpression::canShowChristmasStickers
    CanPlayForFree = 0x2657d44, --GameOfChanceGame::CanPlayForFree
    get_totalItemsCount = 0x362a3e8, --ProtoStorageLevel::get_totalItemsCount
    get_IsCheaterFixOn = 0x383443c, --BoatRaceV4Context::get_IsCheaterFixOn
    get_CheaterTrackingEnabled = 0x3828298, --BoatRaceV4Context::get_CheaterTrackingEnabled
    set_CheaterTrackingEnabled = 0x38282a0, --BoatRaceV4Context::set_CheaterTrackingEnabled
    CheaterFixedScore = 0x3834a28, --BoatRaceV4Context::CheaterFixedScore
    get_Suspended = 0x2d975a0, --ZyngaUsersession::get_Suspended
    set_Suspended = 0x2d975a8, --ZyngaUsersession::set_Suspended
    Start = 0x2acd428, --ZyngaPlayerSuspensionManager::Start
    get_amount = 0x33282b0, --ProtoQuestReward::get_amount
    get_GetCurrentLeaguePersonalQuota = 0x37fc64c, --BoatRaceLeagueManager::get_GetCurrentLeaguePersonalQuota
    get_personalQuotaCompleted = 0x2c5e8e8, --BaseBoatRaceContext::get_personalQuotaCompleted
    get_bonusTaskCount = 0x2c5e8a8, --BaseBoatRaceContext::get_bonusTaskCount
    get_GetBonusTaskSkipPrice = 0x26af6c4, --BoatRace_TaskTabViewModel::get_GetBonusTaskSkipPrice
    getAmount = 0x3329240, --ProtoQuestTask::getAmount
    set_MyWeeklyContribution = 0x385db40, --CoopOrderHelpContext::set_MyWeeklyContribution
    StartCrafting = 0x2ab5578, --WorkshopManager::StartCrafting
    get_inventoryTokens = 0x2f1d564, --BattlePassManager::get_inventoryTokens
    isEntityObstructed = 0x2fec9d0, --EntityPlacementController::isEntityObstructed
    get_IsAvailable = 0x32a8520, --HeroBehavior::get_IsAvailable
    OnTamperDetected = 0x3330e94, --SecureVarInt::OnTamperDetected
    CurrentUnix = 0x355f564, --PartnerAnimalTime::CurrentUnix
    get_SpinLeft = 0x37bb0c8, --SocialDailyBonusManager::get_SpinLeft
    get_groupLimit = 0x32175bc, --ProtoMarketItem::get_groupLimit
    GetAmount = 0x333dee0, --ProtoLootInfoExtensions::GetAmount
    GetDropRate = 0x333f718, --ProtoLootInfoExtensions::GetDropRate
  }
}
